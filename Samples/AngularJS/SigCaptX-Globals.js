...
var imageBoxDSV;              // Points to the image box for the current signature when capturing 2 signatures for DSV
...
const TIMEOUT = 3000;         //  Timeout value for connecting to the port used for the SigCaptX service
