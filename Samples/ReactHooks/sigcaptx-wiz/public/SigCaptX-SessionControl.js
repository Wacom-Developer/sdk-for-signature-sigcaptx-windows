...
{
  body_onload : function(txtDisplay, imageBox)
  {
    // txtDisplay and imageBox are HTML element objects passed through from the form
  ...
  start_stop : function(bShowSigText, bDisplayWiz, bUseLargeCheckBox, btnStartStopWizard, txtDisplay, imageBox, buttonStyle)
  {
    // Save various HTML elements on to the window global object for later use
    window.bShowSigText = bShowSigText;
    window.bDisplayWizard = bDisplayWiz;
    window.bUseLargeCheckBox = bUseLargeCheckBox;
...
function actionWhenRestarted(callback) 
{
  ...
  var wizCtlTest = null;
	...
	window.imageBox.firstChild = null;
