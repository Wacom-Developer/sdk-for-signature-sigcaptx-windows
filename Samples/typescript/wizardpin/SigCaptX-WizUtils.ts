...
export class WizDisplay
{
  ...
  public static addTextObject(textObject, callbackRoutine)
  {
  ...
  public static addButtonObject(buttonObj, callbackRoutine)
  {
    var xVar = new window.sdkPtr.Variant();
    var yVar = new window.sdkPtr.Variant();
    var objData = new window.sdkPtr.Variant();
  ...
  public static addRadioButton(radioButtonObj, callbackRoutine)
  {
    var xVar = new window.sdkPtr.Variant();
    var yVar = new window.sdkPtr.Variant();
    var objData = new window.sdkPtr.Variant();
...
{
  var txtDisplay = (<HTMLInputElement>document.getElementById("txtDisplay"));
