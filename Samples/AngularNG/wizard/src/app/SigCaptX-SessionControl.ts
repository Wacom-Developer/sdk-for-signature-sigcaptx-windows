...
import {  WizScreens } from './SigCaptX-Wizard-Main';
import { PadDefs, screen_Display1, screen_Display2, screen_Display3 } from './SigCaptX-Wizard-PadDefs';
...
export class SessionControl
{
  ...
  static onGetPadHeight(wizCtlV, padHeight, status)
  {
    ...
    { 
      ...
      window.pad = new PadDefs(window.width, window.height, chkBoxSize);
      ...
      window.display_1 = new screen_Display1(window.pad, buttonTextSource);
      window.display_2 = new screen_Display2(window.pad, buttonTextSource);
      window.display_3 = new screen_Display3(window.pad, buttonTextSource);
      WizScreens.step1();
    }
    else
    {
