/* **************************************************************************
  ...
  The object classes are defined in WizUtils.js
...
***************************************************************************/
import { buttonEvent, ButtonObject, padColors, padRange, padType, TextObject } from '../src/components/WizUtils.js';

export function STUPadDefs (padWidth, padHeight)
{
  this.Font = "Verdana";
...
export function Screen_Display1 (pad)
{
